...
var Editor = class _Editor {
  ...
  initQuillEditor() {
    ...
    if (!this.dynamicQuill) {
      import("./quill-EIY4RA2I.js").then((quillModule) => {
  ...
  static ɵfac = function Editor_Factory(ɵt) {
    return new (ɵt || _Editor)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(PLATFORM_ID));
  };
...
var EditorModule = class _EditorModule {
  static ɵfac = function EditorModule_Factory(ɵt) {
    return new (ɵt || _EditorModule)();
  };
